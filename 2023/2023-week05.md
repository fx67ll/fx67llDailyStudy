...
### 前端面试题  
**JS 事件循环了解吗？ or JS Event Loop 了解吗**  
1. [JS 事件循环（Event Loop）](https://segmentfault.com/a/1190000043365558)  
2. [前端面试真题宝典（一） ---- 简述事件循环原理](https://blog.csdn.net/shadowfall/article/details/127287451)  
...
### 前端面试题  
**什么是闭包？工作中用到过闭包吗？**  
1. 一个函数的作用域可以访问另一个函数的局部变量，这个变量所在的函数就是闭包函数  
2. [前端面试真题宝典（一） ---- 闭包和柯里化](https://blog.csdn.net/shadowfall/article/details/127287451)  
